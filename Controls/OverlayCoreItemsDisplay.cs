...
{
	public partial class OverlayCoreItemsDisplay : UserControl
	{
		CoreItemsDisplayModel _Model;
		public CoreItemsDisplayModel Model { set { _Model = value; RefreshDisplays(); } }
		
		public OverlayCoreItemsDisplay()
		{
			InitializeComponent();
		}
